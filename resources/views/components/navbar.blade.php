...
<nav class="navbar fixed-top navbar-expand-lg" id="navbar">
    ...
    <a class="navbar-brand" href="#">
      <img style="border-radius:50%" src="{{asset('immagini/logo.png')}}" width="50" height="50" class="d-inline-block align-top" alt="">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
        <div class="navbar-nav" id="navbar-list">
    ...
    <label id="theme-toggle-button">
        ...
        <svg viewBox="0 0 69.667 44" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xlink="http://www.w3.org/2000/svg">
